...
insert into round (event, idx, level, judge) select event.id,14, 2, judge.id from event, judge, person where date = "February 22, 2015" and location = "Kamloops"  and judge.id=person.id and person.name = "Courtenay Wa
tson";
